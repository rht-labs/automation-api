...
create table automation.access_mode (pvc_id int8 not null, access_modes int4);
...
alter table automation.access_mode add constraint FKqjfcfllrr4hpbgw3ntq52dehq foreign key (pvc_id) references automation.persistent_volume;
