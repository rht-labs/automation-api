  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, application.id) &&
        Objects.equals(this.baseImage, application.baseImage) &&
        ...
        Objects.equals(this.scmUrl, application.scmUrl) &&
        Objects.equals(this.scmType, application.scmType) &&
        Objects.equals(this.scmRef, application.scmRef) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, baseImage, baseImageTag, buildApplicationCommands, buildTool, buildImageCommands, deployImageCommands, contextDir, scmUrl, scmType, scmRef, name, labels, environmentVariables, pvcAssociations, routes);
  }
